...
The described DID method details the verification process of an Organization identity on Diplome ethereum-like oracle.
...
Setails that are included in the DID Document are:
...
CRUD base operations and some more advanced use cases.
